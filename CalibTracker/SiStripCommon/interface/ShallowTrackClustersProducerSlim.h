...
class ShallowTrackClustersProducerSlim : public edm::EDProducer {
public:
  explicit ShallowTrackClustersProducerSlim(const edm::ParameterSet&);
private:
  ...
  struct moduleVars {
    ...
    int subdetid, side, layerwheel, stringringrod, petal, stereo, upper;
    uint32_t module;
  };
