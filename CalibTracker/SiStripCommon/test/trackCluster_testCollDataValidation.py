...
process.source.fileNames = cms.untracked.vstring('file:ZB100X_dataRun2_PromptLike_v1_RelVal_zb2017F-v1_1.root') #test_shallowTrackAndClusterFullInfo2016run284078.root.root
...
if found > 0:
    ...
    print(input)
    process.TFileService.fileName = inputStr + 'analyzer.root' 
else:
    process.TFileService.fileName = 'test_shallowTrackAndCluster_test.root'
    #process.TFileService.fileName = 'test_shallowTrackAndCluster_ZBData.root'
